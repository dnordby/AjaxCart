...
export default function () {
  ...
  $('#add').click(function(e){
    ...
    var newLineItem =   `<div class="js-line-item">
                          ...
                          <p class="js-subtract pointer js-update" data-action="decrease">SUBTRACT</p>
  ...
  $(document).on('click', '.js-update', function(){
    ...
    // REQUIRES ACTION ('increase' or 'decrease' ONLY), VARIANT ID, CURRENT QUANTITY IN CART, AND TOTAL AVAILABLE
    // RETURNS UPDATED CART OBJECT
